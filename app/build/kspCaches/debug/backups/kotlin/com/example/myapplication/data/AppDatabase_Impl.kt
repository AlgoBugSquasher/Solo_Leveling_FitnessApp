...
public class AppDatabase_Impl : AppDatabase() {
  ...
  protected override fun createOpenDelegate(): RoomOpenDelegate {
    val _openDelegate: RoomOpenDelegate = object : RoomOpenDelegate(9, "2f9777c39981693d7e1092fc42dfe857", "7abbef22ade65e7001a15a5e4933382b") {
      public override fun createAllTables(connection: SQLiteConnection) {
        ...
        connection.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '2f9777c39981693d7e1092fc42dfe857')")
      }
  ...
  protected override fun createInvalidationTracker(): InvalidationTracker {
    ...
    return InvalidationTracker(this, _shadowTablesMap, _viewTables, "user_table", "workout_table", "exercise_table", "ability_table", "title_table")
  }

  public override fun clearAllTables() {
    super.performClear(true, "user_table", "workout_table", "exercise_table", "ability_table", "title_table")
  }
